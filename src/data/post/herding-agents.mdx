...
Work is scoped to small meaningful changes that make progress on their own. Standard engineering stuff. Sometimes I ask for changes with loose definitions, and through the design discussion I am able to split it up into smaller, well-defined, manageable pieces. In practice, these chunks of work take between 20m and 2hrs to complete. It's not a target I aim for, just a consequence of tightly scoped work.
